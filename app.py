...
try:
    ...
    st.error("Erro ao importar módulo utils. Verifique se o arquivo existe no diretório correto.")
    st.stop()

# Importações dos módulos components
try:
    ...
    st.error("Erro ao importar módulo components. Verifique se o arquivo existe no diretório correto.")
    st.stop()
